...
from launcher import biometix_morphed, biometix_genuine
...
def get_morphed_genuine_pairs(n_images):
    ...
    for img_path in biometix_morphed[0:n_images]:
        ...
        genuine_path = next(x for x in biometix_genuine if pattern_current_genuine_id.search(x) is not None)
...
def get_morphed_images(n_images):
    return _get_n_images(n_images, biometix_morphed)


def get_genuine_images(n_images):
    return _get_n_images(n_images, biometix_genuine)


def get_nth_morphed_image(index):
    return _get_nth_image(index, biometix_morphed)


def get_nth_morphed_genuine_pair(index):
    morphed_path = biometix_morphed[index]
...
def get_nth_genuine_image(index):
    return _get_nth_image(index, biometix_genuine)
